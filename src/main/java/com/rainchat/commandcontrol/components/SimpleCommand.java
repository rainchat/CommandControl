package com.rainchat.commandcontrol.components;

import com.rainchat.commandcontrol.annotations.Completion;
import com.rainchat.commandcontrol.annotations.Option;
import com.rainchat.commandcontrol.annotations.Permission;
import com.rainchat.commandcontrol.services.MessageService;
import com.rainchat.commandcontrol.services.TabCompleterService;
import com.rainchat.commandcontrol.services.TypeParserService;
...
public class SimpleCommand implements CommandExecutor, TabCompleter {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        String[] bestCompletions = findBestCompletions(fullCommand, completionMethods);
        if (bestCompletions != null) {
            String[] fullCommandParts = fullCommand.split(" ");
            int completionIndex = fullCommandParts.length - bestCompletions.length;
    ...
    private String[] findBestCompletions(String fullCommand, Map<String, String[]> completions) {
